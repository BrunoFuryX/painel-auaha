...
export default function Usuarios(props) {
      ...
      return(
        <div className={ "sombra" }>
          <div className={ "aviso" }>
            ...
            <div className={ "aviso__actions" }></div>
            {!confirm 
            ?
            ...
            :
            <>
            <button className={ "aviso__cancel" } onClick={ e => setMsg(false)}>
              Cancelar
            </button>
            <button className={ "aviso__confirm" } onClick={ e => setMsg(false)}>
              Confirmar
            </button>
            </>
            }
  ...
  const ChamarAviso = (props) => {
    const preview = props.preview
    const confirm = props.confirm
    const msg = props.msg
    return(
      <>
        <Aviso preview={preview} msg={msg} confirm={confirm} />
      </>
    )
  }
  ...
  const Listagem = (props) => {
    ...
    const listafeita = lista.map((item, index) => {
      return(
        <div key={item.id} className={ "item" } >
            ...
            <div className={ "acoes" }>
              ...
              <button className="editar" onClick={ () => Excluir(item.id)}>
        ...
        <div className={ "cadastro" }>
          <div className={ "cadastro__container" }>
              ...
              <form onSubmit={ e => enviarForm(e) }>
                  ...
                  <input name={ "store" }  placeholder={ "Loja" }  value={ store } onChange={(e) => setStore(e.target.value)}/>
